{{--
    ...
    Props:
        ...
        - error (optional): string|null - pass validation error message manually.
        - placeholder (optional): string.
        - rows (optional): int - number of rows (default: 4).
--}}
@props(['label' => null, 'name' => null, 'id' => null, 'value' => '', 'required' => false, 'error' => null, 'placeholder' => '', 'rows' => 4])
...
<div class="mb-4">
    ...
    <textarea 
        ...
        {{ $required ? 'required' : '' }}
        class="w-full px-4 py-2 rounded-lg border {{ $hasError ? 'border-red-500 dark:border-red-500' : 'border-slate-300 dark:border-slate-700' }} bg-white dark:bg-slate-800 text-slate-900 dark:text-white placeholder-slate-500 dark:placeholder-slate-400 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition resize-none"
        {{ $attributes }}

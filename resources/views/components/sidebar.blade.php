    ...
    <div class="h-full overflow-y-auto">
        <div class="p-6 space-y-2" :class="!sidebarOpen && 'lg:px-3'">
            <nav class="space-y-1">
                ...
                <x-sidebar-link href="{{ route('categories.index') }}" label="Kategori" :active="request()->routeIs('categories.*')">
                    <x-slot:icon>
                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <x-sidebar-link href="{{ route('items.index') }}" label="Barang" :active="request()->routeIs('items.*')">
                    <x-slot:icon>
                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <x-sidebar-link href="{{ route('transactions.index') }}" label="Penjualan" :active="request()->routeIs('transactions.*')">
                    <x-slot:icon>
                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
